...
export default class Weather extends React.Component {
  ...
  handleSubmit = (event) => {
    ...
    axios
      .get(
        `https://api.openweathermap.org/geo/1.0/direct?q=${this.state.cityInputValue}&limit=1&appid=3540653b10b634e1bdacc26d27f1e270`,
      )
      ...
      .then((cityGeoData) =>
        axios.get(
          `https://api.openweathermap.org/data/2.5/weather?lat=${cityGeoData.lat}&lon=${cityGeoData.lon}&appid=3540653b10b634e1bdacc26d27f1e270&units=metric`,
        ),
      )
      .then((response) => {
